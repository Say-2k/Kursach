...
namespace Kursach
{
    public partial class students : Form
    {
        ...
        private void FieldsForm_Fill()
        {
            ...
            textBox4.Text = menu.ds.Tables["student"].Rows[n]["birthday"].ToString();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if(n == menu.ds.Tables["passport"].Rows.Count)
            {
                ...
                textBox1.Enabled = false;
                menu.ds.Tables["passport"].Rows.Add(new object[] { textBox1.Text, maskedTextBox1.Text, maskedTextBox2.Text, maskedTextBox3.Text, textBox5.Text, dateTimePicker1.Value });
            }
            else
            {
                ...
                menu.Modification_Execute(sql);
                menu.ds.Tables["passport"].Rows[n].ItemArray = new object[] { textBox1.Text, maskedTextBox1.Text, maskedTextBox2.Text, maskedTextBox3.Text, textBox5.Text, dateTimePicker1.Value };
            }
            if (n == menu.ds.Tables["vb"].Rows.Count)
            {
                sql = "INSERT INTO vb values(" + textBox1.Text + ", '" + comboBox1.Text + "', '" + maskedTextBox4.Text.ToUpper() + "', " + maskedTextBox5.Text + ")";
                menu.Modification_Execute(sql);
                textBox1.Enabled = false;
                menu.ds.Tables["vb"].Rows.Add(new object[] { textBox1.Text, comboBox1.Text, maskedTextBox4.Text.ToUpper(), maskedTextBox5.Text });
            }
            else
            {
                sql = "UPDATE vb SET category='" + comboBox1.Text + "', vb_serial='" + maskedTextBox4.Text.ToUpper() + "', vb_number=" + maskedTextBox5.Text + " WHERE vb_code=" + textBox1.Text;
                menu.Modification_Execute(sql);
                menu.ds.Tables["vb"].Rows[n].ItemArray = new object[] { textBox1.Text, comboBox1.Text, maskedTextBox4.Text.ToUpper(), maskedTextBox5.Text };
            }
            if (n == menu.ds.Tables["student"].Rows.Count)
            {
                sql = "INSERT INTO student values(" + textBox1.Text + ", '" + textBox2.Text + "', '" + textBox6.Text + "', '" + textBox7.Text + "', " + textBox4.Text + ", " + textBox3.Text + ")";
                menu.Modification_Execute(sql);
                textBox1.Enabled = false;
                menu.ds.Tables["student"].Rows.Add(new object[] { textBox1.Text, textBox2.Text, textBox6.Text, textBox7.Text, textBox4.Text, textBox3.Text });
            }
            else
            {
                sql = "UPDATE student SET surname='" + textBox2.Text + "', name='" + textBox6.Text + "', patronymic='" + textBox7.Text + "', birthday=" + textBox4.Text + ", vuz_code=" + textBox3.Text + " WHERE student_code=" + textBox1.Text;
                menu.Modification_Execute(sql);
                menu.ds.Tables["student"].Rows[n].ItemArray = new object[] { textBox1.Text, textBox2.Text, textBox6.Text, textBox7.Text, textBox4.Text, textBox3.Text };
            }
        }
